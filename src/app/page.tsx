    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="relative overflow-hidden py-24 md:py-32">
          ...
          <div className="absolute top-1/4 left-10 w-64 h-64 rounded-full bg-primary/5 blur-3xl animate-float-gentle" />
          <div className="absolute bottom-1/4 right-10 w-48 h-48 rounded-full bg-primary/5 blur-3xl animate-float-gentle-delayed" />
          <div className="container mx-auto px-4 text-center relative">
            ...
            <ScrollReveal direction="up" delay={900} duration={1000}>
              <div className="mt-8 flex flex-wrap items-center justify-center gap-4">
                <Link href="/auth">
                  <span className="btn-primary inline-block px-8 py-3 text-lg transition-all duration-500 hover:scale-105 hover:shadow-lg hover:shadow-primary/30">
                    Start Learning Free
                  </span>
                </Link>
                <Link href="/auth" className="btn-outline inline-block px-8 py-3 text-lg transition-all duration-500 hover:scale-105 hover:shadow-lg">
                  Watch Demo
                </Link>
              </div>
            </ScrollReveal>
            ...
            <div className="grid gap-8 md:grid-cols-3">
              {[
                ...
                <ScrollReveal key={item.title} direction="up" delay={i * 300} duration={1000}>
                  <div className="card-hover p-8 group transition-all duration-700 hover:-translate-y-3 hover:shadow-xl">
                    <div className="mb-4 text-primary transition-all duration-500 group-hover:scale-110 group-hover:rotate-3">
                      {item.icon}
                    </div>
                    <h3 className="mb-2 text-xl font-heading font-bold transition-colors duration-500 group-hover:text-primary">
                      {item.title}
                    </h3>
        ...
        <section className="py-20 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative">
            <div className="mx-auto max-w-2xl">
              ...
              <ScrollReveal direction="up" delay={900} duration={1000}>
                <Link href="/auth">
                  <span className="btn-primary inline-block px-10 py-3 text-lg transition-all duration-500 hover:scale-105 hover:shadow-lg hover:shadow-primary/30 animate-glow-pulse">
                    Get Started Free
                  </span>
                </Link>
              </ScrollReveal>
